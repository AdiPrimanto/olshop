<!-- Topnav -->
<nav class="navbar navbar-top navbar-expand navbar-light bg-linier-gradient border-bottom">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center ml-md-auto">
            ...
            <!-- Menu beside notification -->
            <li class="nav-item dropdown">
            <a class="btn btn-info btn-sm rounded-pill" href="sales.php">Upgrade Package</a>
            </li>
            <!-- Notification -->
            <li class="nav-item dropdown">
